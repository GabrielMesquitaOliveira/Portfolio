    ...
    <div className="container">
      ...
      <div className="flex flex-col mt-10 gap-14">
        {portfolioProjects.map((project) => (
          <div key={project.title} className="bg-gray-800 rounded-3xl relative z-0 overflow-hidden after:content-[''] after:z-10 after:absolute after:inset-0 after:outline-2 after:outline after:-outline-offset-2 after:rounded-3xl after:outline-white/20 mb-8 p-8 after:pointer-events-none">
            ...
            <ul className="flex flex-col gap-4 mt-4">
              {project.results.map((result) => (
                <li className="flex gap-2 items-center text-white/50" key={result.title}>
            ...
            <a href={project.link} target="_blank" className="cursor-pointer" rel="noreferrer">
              <button className="bg-white text-gray-950 h-12 w-full rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-6">
                View Project
